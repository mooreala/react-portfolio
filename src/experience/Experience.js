...
function Experience() {
  return (
    <Container>
      ...
      <Jobs>
        <Job title="Software Engineering Intern" date="Apr 2022 - Present" company="Intel" 
          description={["Automating cloud solutions for system configuration updates", 
          "Contributing to REST API development", 
          "Promoting team inclusivity by facilitating weekly newsletters and surveys"
          ]}
        />
        <Job title="Software Engineering Intern" date="Aug 2021 - Dec 2021" company="Starbucks DevOps"
          description={["Collaborated on a digital store simulation that functionally represents a Starbucks store", 
        ...
        />
        <Job title="Software Engineering Intern" date="May 2021 - Aug 2021" company="Apple"
          description={["Worked on apple-made plugins for Unity to support game controller usage and iOS play store achievements",
