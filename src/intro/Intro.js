  ...
  return (
    <Container>
      <IntroText>
        ...
        <p>
          I am a software developer slash design fanatic, with an interest in front-end development, human computer interaction, and AI. I am currently working as Software Application Development Engineer at Intel, and I work on enterprise facing web-applications with regards to user experience design and back-end service development!
        </p>
        <p>
